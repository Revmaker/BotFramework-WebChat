...
class SuggestedActions extends React.Component<MessagePaneProps, {}> {
    ...
    render() {
        ...
        return (
            <HScroll
                nextSvgPathData={this.props.customNextSvgPathData || "M 12.5 22 L 10 19.5 L 15.5 14 L 10 8.5 L 12.5 6 L 20.5 14 L 12.5 22 Z"}
                prevSvgPathData={this.props.customPrevSvgPathData || "M 16.5 22 L 19 19.5 L 13.5 14 L 19 8.5 L 16.5 6 L 8.5 14 L 16.5 22 Z"}
